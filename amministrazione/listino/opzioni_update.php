...
if($opera!="ON"){
    ...
    $query = "UPDATE opzioni_listino SET larghezza='$larghezza', righe='$righe', ordine='$ordine', mostra_altezza='$mostra_altezza', misura='$misura', contorni='$contorni', moneta='$moneta', separatore='$separatore', font='$font', font_dim='$font_dim', r500='$r500', r400='$r400', r300='$r300', r200='$r200', r100='$r100', r31='$r31', r1='$r1', rsmin='$rsmin'";
