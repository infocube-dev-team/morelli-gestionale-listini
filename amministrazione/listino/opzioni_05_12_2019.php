...
if (!$con)
 ...
 mysql_select_db($localnome, $con);
		...
		$query  = "SELECT larghezza, righe, ordine, mostra_altezza, misura, contorni, moneta, separatore, font, font_dim, r500, r400, r300, r200, r100, r31, r1 FROM opzioni_listino";
