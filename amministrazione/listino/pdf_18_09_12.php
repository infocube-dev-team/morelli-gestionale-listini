...
function Header()
{
    ...
    $this->Cell(30);
    // Title
    $this->Cell(130,18,'La Morelli SPA si riserva, data la enorme instabilità del costo delle materie prime, di attuare eventuali anumenti.',0,0,'C');
    // Line break
    $this->Ln(20);
	...
	// Page number
    $this->Cell(31,-13,'Listino Accessori P/E 2013 A PARTIRE DAL 01/02/2012',0,0,'C');
	...
	// Colonne
    $this->Cell(0,4,'ARTICOLO                                           Acc.        Altezza      500 mt.   400/499mt.  300/399mt.  200/299mt.  100/199mt.   31/99mt.   1/30mt.  Composizione     GR.MQ.',1,1);
}
