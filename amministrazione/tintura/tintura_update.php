...
echo $fornitore_db;
		 ...
		 $query = "UPDATE tintura SET descrizione='$nome', cod_art_fornitore='$cod_art_fornitore', id_fornitore='$id_fornitore', m1='$m1', m2='$m2', m3='$m3', m4='$m4', m5='$m5', m6='$m6', m7='$m7', m8='$m8', c1='$c1', c2='$c2', c3='$c3', c4='$c4', c5='$c5', c6='$c6', c7='$c7', c8='$c8' WHERE id='$id'";
  ...
  $_SESSION['messaggio'] = "Selezionare il nome di un elemento Tintura esistente.";
  $color = "#FF0000";
