...
if (!$con)
 ...
 if($nome!=NULL and $fornitore!=NULL){
	...
	//------------Cerca Doppioni------------
	$query  = "SELECT descrizione FROM greggio";
	...
	if($doppione!="SI"){
    	...
    	mysql_query("INSERT INTO greggio (descrizione, cod_art_fornitore, id_fornitore, m1, m2, m3, m4, m5, m6, m7, m8, c1, c2, c3, c4, c5, c6, c7, c8)
