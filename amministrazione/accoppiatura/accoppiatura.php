...
?>
			   ...
			   <fieldset align="center"> <legend class="titoli">Crea un Elemento Accoppiatura:</legend>
			   
			   <form method="GET" action="accoppiatura.php">
