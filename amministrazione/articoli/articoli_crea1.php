...
if($altezza==NULL){
 $altezza = "0";
   ...
   $query = "UPDATE articoli SET codice='$codice', collezione='$collezione', composizione='$composizione', altezza='$altezza', stampa='$stampa', operatore='$operatore', data='$data', dettagli='$dettagli', grmq='$grmq', seq_accoppiature='$seq_accoppiature' WHERE id='$id'";
  ...
  if($nome!=NULL){
   $query = "UPDATE articoli SET nome='$nome' WHERE id='$id'";
 	$result = mysql_query($query);
		...
		//------------Seleziona articolo------------
		$query  = "SELECT codice, nome, collezione, composizione, altezza, stampa, dettagli, grmq, seq_accoppiature FROM articoli WHERE id = '$id'";
		$result = mysql_query($query);
...
if(isset($modifica_elemento)){
 ...
 if($tipo_lav=="greggio"){
   $query = "UPDATE greggio SET m1='$m1', m2='$m2', m3='$m3', m4='$m4', m5='$m5', m6='$m6', m7='$m7', m8='$m8', m9='$m9', c1='$c1', c2='$c2', c3='$c3', c4='$c4', c5='$c5', c6='$c6', c7='$c7', c8='$c8', c9='$c9' WHERE id='$id_mod_elemento'";
	$result = mysql_query($query);
 ...
 if($tipo_lav=="tintura"){
   $query = "UPDATE tintura SET m1='$m1', m2='$m2', m3='$m3', m4='$m4', m5='$m5', m6='$m6', m7='$m7', m8='$m8', m9='$m9', c1='$c1', c2='$c2', c3='$c3', c4='$c4', c5='$c5', c6='$c6', c7='$c7', c8='$c8', c9='$c9' WHERE id='$id_mod_elemento'";
	$result = mysql_query($query);
 ...
 if($tipo_lav=="finissaggio"){
   $query = "UPDATE finissaggio SET m1='$m1', m2='$m2', m3='$m3', m4='$m4', m5='$m5', m6='$m6', m7='$m7', m8='$m8', m9='$m9', c1='$c1', c2='$c2', c3='$c3', c4='$c4', c5='$c5', c6='$c6', c7='$c7', c8='$c8', c9='$c9' WHERE id='$id_mod_elemento'";
	$result = mysql_query($query);
 ...
 if($tipo_lav=="accoppiatura"){
   $query = "UPDATE accoppiatura SET m1='$m1', m2='$m2', m3='$m3', m4='$m4', m5='$m5', m6='$m6', m7='$m7', m8='$m8', m9='$m9', c1='$c1', c2='$c2', c3='$c3', c4='$c4', c5='$c5', c6='$c6', c7='$c7', c8='$c8', c9='$c9' WHERE id='$id_mod_elemento'";
	$result = mysql_query($query);
 ...
 if($tipo_lav=="supporti"){
   $query = "UPDATE supporti SET m1='$m1', m2='$m2', m3='$m3', m4='$m4', m5='$m5', m6='$m6', m7='$m7', m8='$m8', m9='$m9', c1='$c1', c2='$c2', c3='$c3', c4='$c4', c5='$c5', c6='$c6', c7='$c7', c8='$c8', c9='$c9' WHERE id='$id_mod_elemento'";
	$result = mysql_query($query);
			 ...
			 <td align="center">
			   ...
			   <?php
				...
				if(isset($id_modifica) AND $tipo_lavorazione!=NULL){
					...
					$query  = "SELECT descrizione, id_fornitore, m1, m2, m3, m4, m5, m6, m7, m8, m9, c1, c2, c3, c4, c5, c6, c7, c8, c9, cod_art_fornitore FROM $tipo_lavorazione WHERE id='$id_modifica'";
					$result = mysql_query($query);
				...
				<div align="center">
					<table border="0" cellspacing="0" id="table3">
						...
						<tr>
							...
							<td>
							 <input <?php echo $disable;?> type="text" name="m9" size="7" id="m9" value="<?php echo $m9;?>">
							</td>
						</tr>
						<tr>
							<td>Costo (Euro):</td>
							...
							<td>
							 <input <?php echo $disable;?> type="text" name="c9" size="7" id="c9" value="<?php echo $c9;?>">
							</td>
						</tr>
						<tr>
							<td colspan="9">
						 ...
						 $result = mysql_query($query);
							while($row = mysql_fetch_row($result))
							{
								...
								$metraggio_unico = NULL;
								 ...
								 //------------Seleziona elemento ------------
								 $queryx  = "SELECT descrizione, m1, m2, m3, m4, m5, m6, m7, m8, m9, c1, c2, c3, c4, c5, c6, c7, c8, c9, id_fornitore FROM $tipo WHERE id='$id_edb'";
...
// fino al successivo commento indicato con il carattere ****								 
							   ...
							   //----------Prezzi Unici------------------
								 if($m2[0]==0){
								  ...
								  $metraggio_unico = "SI";
								   for($i=1;$i<$nummax_metrature+1;$i++)
								      ${"c$i"} = $c1;
									...
									<table border="0" cellspacing="3" id="table5" width="100%">
										...
										//-------------trovo tutti i valori di metratura------------------
										 for($i=1;$i<$nummax_metrature+1;$i++){
										  ...
										  if($metraggio_unico=="NO"){
											   for($i=2;$i<$nummax_metrature+1;$i++){
											   	   if(${"m$i"}[0]>0){
														?>
						 ...
						 $result = mysql_query($query);
							while($row = mysql_fetch_row($result))
							{
								...
								$idcomb = $row[2];
								 ...
								 //------------Seleziona elemento ------------
								 $queryx  = "SELECT descrizione, m1, m2, m3, m4, m5, m6, m7, m8, m9, c1, c2, c3, c4, c5, c6, c7, c8, c9 FROM $tipo WHERE id='$id_edb'";
								 $resultx = mysql_query($queryx);
								  $rowx = mysql_fetch_row($resultx);
									{
										$nome = $rowx[0];
							...
							//--------------Calcolo prezzo metrature----------------
								...
								for($i=1; $i<$nummax_metrature+1; $i++){
								  for($j=1; $j<$nummax_metrature+1; $j++){
				...
				?>
					...
					<div align="center">
						...
						<tr>
							...
							<td><?php if($am9db[0]!=0) echo $am9db[0]."/".$am9db[1];?></td>
						</tr>
						...
						<tr>
							...
							<td><?php if($am9db[0]!=0) echo $ac9db;?></td>
						</tr>
						...
						<tr>
							...
							<td> <?php if($am9db[0]!=0) echo $ac9db+round(($ac9db*$i/100), 2);?> </td>
						</tr>
						<?php
						}
						?>
