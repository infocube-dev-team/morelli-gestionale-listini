...
if(isset($modifica_articolo)){
    ...
    $query = "UPDATE articoli SET codice='$codice', collezione='$collezione', composizione='$composizione', altezza='$altezza', stampa='$stampa', operatore='$operatore', data='$data', dettagli='$dettagli', grmq='$grmq', seq_accoppiature='$seq_accoppiature', minimo='$minimo', smin='$smin' WHERE id='$id'";
...
//------------Seleziona articolo------------
$query  = "SELECT codice, nome, collezione, composizione, altezza, stampa, dettagli, grmq, seq_accoppiature, minimo, smin FROM articoli WHERE id = '$id'";
$result = mysql_query($query);
    ...
    <form method="GET" action="articoli_crea.php">
        ...
        <div align="center">
            <table border="0" id="table1">
                ...
                <tr>
                    <td align="center">
                        <fieldset> <legend class="titoli">Articolo:&nbsp;&nbsp;&nbsp; (<?php echo $nome."  ".$nome_seq_accoppiature;?>)&nbsp;&nbsp;
                            ...
                            &nbsp;<div align="center">
                                <table border="0" cellspacing="0" id="table2">
                                    ...
                                    <tr>
                                        <td>Minimo:</td>
                                        <td>
                                            <input type="text" name="minimo" size="19" id="minimo" value="<?php echo $minimo;?>"></td>
                                    </tr>
                                    <tr>
                                        <td>Sotto Minimo:</td>
                                        <td>
                                            <input type="text" name="smin" size="19" id="smin" value="<?php echo $smin;?>"></td>
                                    </tr>
                ...
                <tr>
                    <td align="center">
                        ...
                        <fieldset> <legend class="articolo"> (<?php echo strtoupper($nome." ".$nome_seq_accoppiature);?>) </legend>
                            ...
                            <?php
                            $attiva_2 = ($smin != null && $smin != 0 && $smin != "")? 1 : 0;
                            $attiva_1 = 0;
                            $metratura_nulla = 0;
                                            ...
                                            while($row = mysql_fetch_row($result))
                                            {
                                                ...
                                                <tr>
                                                    <td colspan="5">
                                                        ...
                                                        <?php
                                                        //---in caso di modifica copiare in articolo_stampa da qui!!!
                                                        // fino al successivo commento indicato con il carattere ****
                                                                    ...
                                                                    for($i=1;$i<9;$i++){
                                                                        if(${"m$i"}[0]!=0){
                                                                            ...
                                                                            if(count($metratura)<2){
                                                                                ...
                                                                                //valuto la differenza tra la metratura in esame e quelle gi� presenti
                        ...
                        <fieldset> <legend class="info"> Totali:</legend>
                            ...
                            while(list($tipo,$valore)=each($tipologia)){
                                ...
                                while($row = mysql_fetch_row($result))
                                {
                                    ...
                                    for($i=1; $i<=count($metratura); $i++){
                                        for($j=1; $j<9; $j++){
                                            ...
                                            if( $m1tmp[1] == 0){
                                                ...
                                                //verifico se ho un valore pi� piccolo del range pi� basso
                                                ${"ac$i"."db"} = ${"ac$i"."db"} + $c1;
                                                break;
                                            }elseif(${"m$j"."tmp"}[0] <= ${"am$i"."db"}[0] && ${"am$i"."db"}[0] <= ${"m$j"."tmp"}[1]){
                                                // ho individuato il range di metratura
                                                // devo verificare se il range successivo � di poco pi� grande
                                    ...
                                    $m0list=1;
                                    $m1list=($minimo != null && $minimo != 0)? $minimo : 31;
                                    $m2list=100;
                                    $m3list=200;
                                    $m4list=300;
                                    $m5list=400;
                                    $m6list=500;
                                    $m0list= ($smin != null && $smin != 0)? $smin : "";
                ...
                <tr>
                    <td align="center">
                        ...
                        <fieldset> <legend class="info"> Listino:</legend>
                            ...
                            //---------------metto il ricarico----------
                            //------------Seleziona ricarichi------------
                            $query  = "SELECT r1, r31, r100, r200, r300, r400, r500, rsmin FROM opzioni_listino";
                            $result = mysql_query($query);
                            $row = mysql_fetch_row($result);
                            {
                                $r1 = $row[0];
                            ...
                            if ($attiva_2==1){
                                $c7listf = $c1listf + ($c1listf * ($rsmin / 100));
                            }
                            else {
                                $c7listf = "-";
                            };
                            ...
                            <div align="center">
                                <table border="2" cellspacing="1" id="table7">
                                    <tr>
                                        <td>Metrature:</td>
                                        <td align="center"><b><?php echo ($attiva_2==1) ? $smin."/".($m1list-1) : ""; ?></b></td>
...
<!--                                        <td align="center">--><?php //echo $c6list;?><!--</td>-->
                                    ...
                                    <tr>
                                        <td>Ricarico:</td>
                                        <td align="center"><?php echo ($attiva_2==1) ?  round ($c1listf + ($c1listf * $rsmin / 100), 2): "";?></td>
...
<!--                                        <td align="center">--><?php //echo $c6listf;?><!--</td>-->
                                    ...
                                    $diffc =array('cm1'=> 0, 'cm31'=> 0 , 'cm100'=> 0, 'cm200'=> 0, 'cm300'=> 0, 'cm400'=> 0, 'cm500'=> 0, 'cmsmin' => 0);
                                    $diff=array();
                                    $diff[0]=0;
                                    if(isset($_GET['Ricalcola'])){
                                        ...
                                        $query = "UPDATE articoli SET cmsmin ='$diff[7]', cm1='$diff[0]', cm31='$diff[1]', cm100='$diff[2]', cm200='$diff[3]', cm300='$diff[4]', cm400='$diff[5]', cm500='$diff[6]' WHERE id='$id'";
                                        $result = mysql_query($query);
                                    }
                                    else {
                                        if(isset($modifica_articolo)) {
                                            if (($diff[7] == null || $diff[7] == 0) && ($attiva_2==1)) {
                                                $diff[7] = round ($c1listf + ($c1listf * $rsmin / 100), 2);
                                                $query = "UPDATE articoli SET cmsmin ='$diff[7]' WHERE id='$id'";
                                                $result = mysql_query($query);
                                            }
                                        }
                                    }
                                    ...
                                    $query  = "SELECT cm1, cm31, cm100, cm200, cm300, cm400, cm500, cmsmin FROM articoli WHERE id='$id'";
                                    $result = mysql_query($query);
                                    $row = mysql_fetch_row($result);
                                    {
                                        $diff[0] = $row[0];
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"> <font color="#<?php echo $color7;?>"> <?php echo ($attiva_2==1)? round($diff[7]-$c7listf, 2) : "-";?> </font> </td>
                                        <td align="center"> <font color="#<?php echo $color1;?>"> <?php echo round($diff[1]-$c1listf, 2);?> </font> </td>
...
<!--                                        <td align="center"> <font color="#--><?php //echo $color6;?><!--"> --><?php //echo round($diff[6]-$c6listf, 2);?><!-- </font> </td>-->
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"><input type="text" name="cmsmin" size="5" value="<?php echo $diff[7];?>" <?php echo $disabil2?>></td>
                                        <td align="center"><input type="text" name="cm31" size="5" value="<?php echo $diff[1];?>"></td>
...
mysql_query("INSERT INTO listino (id_articolo, 500mt, 400mt, 300mt, 200mt, 100mt, 31mt, 1mt, sminmt)
   VALUES ('$id', '$c6listf', '$c5listf', '$c4listf', '$c3listf', '$c2listf', '$c1listf', '$c0listf', '$c7listf')");
