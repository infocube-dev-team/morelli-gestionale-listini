	    ...
	    $result = mysql_query($query);
			...
			?>
						...
						<tr>
							...
							<td align="center"> <font color="#<?php echo $color0;?>"> <?php if($attiva_1==1){echo $diff[0]-$c0listf;}else{echo "-";};?> </font> </td>
						...
						<tr>
							...
							<td align="center"><input type="text" name="cm1" size="5" value="<?php echo $diff[0];?>" <?php echo $disabil;?>></td>
