...
if (!$con)
 ...
 mysql_select_db($localnome, $con);
  ...
  $id = $_GET['id'];
		...
		//------------Seleziona articolo------------
		$query  = "SELECT codice, nome, collezione, composizione, altezza, stampa FROM articoli WHERE id = '$id'";
			...
			<fieldset> <legend class="titolipiccoli"> Nome Articolo:</legend>
				<div align="center">
					<table border="0" cellspacing="2" cellpadding="2" id="table1">
						<tr>
							<td><b> <font size="3"><?php echo $nome;?></font> </b></td>
						</tr>
					</table>
				</div>
			</fieldset>
	...
	if(isset($_GET['Ricalcola'])){
	   ...
	   // $result = mysql_query($query);
			...
			?>
				...
				<div align="center">
					<table border="0" id="table7" cellpadding="4">
						<tr>
							<td>Metrature:</td>
						...
						<tr>
							<td>Ricarico:</td>
							<td align="center"><?php echo $c1listf+$diff31;?></td>
							<td align="center"><?php echo $c2listf+$diff100;?></td>
							<td align="center"><?php echo $c3listf+$diff200;?></td>
							<td align="center"><?php echo $c4listf+$diff300;?></td>
							<td align="center"><?php echo $c5listf+$diff400;?></td>
							<td align="center"><?php echo $c6listf+$diff500;?></td>
						</tr>
				   </table>
				</div>
