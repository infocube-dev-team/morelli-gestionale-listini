...
if (!$con)
 ...
 mysql_select_db($localnome, $con);
  ...
  $file_handle = fopen("accoppiatura.txt", "rb");

	while (!feof($file_handle) ) {
  	 $line = fgets($file_handle);
  	 $parts = explode("	", $line);
  	  $fornitore = strtoupper(trim($parts[9]));
 ...
 $m8 = '0/0';
		...
		$result = mysql_query($query);
			...
			echo $id_fornitore."	".$descrizione."	".$c1."	".$m1."	".$c2."	".$m2."	".$c3."	".$m3."	".$c4."	".$m4."\n";
			 	 ...
			 	 mysql_query("INSERT INTO accoppiatura (id_fornitore, descrizione, c1, m1, c2, m2, c3, m3, c4, m4, c5, m5, c6, m6, c7, m7, c8, m8)
