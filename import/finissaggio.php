...
if (!$con)
 ...
 mysql_select_db($localnome, $con);
  ...
  $file_handle = fopen("finissaggio.txt", "rb");
	...
	while (!feof($file_handle) ) {
  	 ...
  	 $parts = explode("	", $line);
  	  ...
  	  $m4 = $parts[8];
  	  $c5 = str_replace(",", ".", $parts[11]);
  	  $m5 = $parts[10];
  	  $c6 = str_replace(",", ".", $parts[13]);
  	  $m6 = $parts[12];
  	  $c7 = str_replace(",", ".", $parts[15]);
  	  $m7 = $parts[14];
 ...
 $m8 = '0/0';
		...
		$result = mysql_query($query);
			...
			echo $id_fornitore."	".$descrizione."	".$c1."	".$m1."	".$c2."	".$m2."	".$c3."	".$m3."	".$c4."	".$m4."\n";
			 	 ...
			 	 mysql_query("INSERT INTO finissaggio (id_fornitore, descrizione, c1, m1, c2, m2, c3, m3, c4, m4, c5, m5, c6, m6, c7, m7, c8, m8)
